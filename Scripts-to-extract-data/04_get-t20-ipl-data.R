...
ipl_match_data$venue <- clean_venue_names(ipl_match_data$venue)
...
ipl_batting_innings_level <-
  ipl_batting_innings_level |>
  left_join(ipl_match_data |> mutate(match_id = as.integer(match_id)),
            by = "match_id")
...
# Output Data
write_rds(ipl_batting_innings_level, "Data/T20s/IPL/ipl_batting_innings_level.rds")
...
# Output Data
write_rds(ipl_bowling_innings_level, "Data/T20s/IPL/ipl_bowling_innings_level.rds")
