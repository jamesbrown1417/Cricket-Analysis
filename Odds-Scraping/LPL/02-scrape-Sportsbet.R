...
player_props_function <- function() {
  ...
  write_csv(first_over_runs,
            "Data/T20s/LPL/scraped_odds/sportsbet_first_over_runs_first_innings.csv")
  write_csv(first_dismissal_data,
            "Data/T20s/LPL/scraped_odds/sportsbet_first_dismissal_first_innings.csv")
  write_csv(first_wicket_runs,
            "Data/T20s/LPL/scraped_odds/sportsbet_runs_at_first_wicket_first_innings.csv")
