...
async def main():
    ...
    async with webdriver.Chrome(options=options) as driver:
        await driver.get('https://www.bet365.com.au/#/AC/B3/C20982223/D720/E1246/F720/')
        ...
        with open(f"Odds-Scraping/LPL/Bet365/h2h_html.txt", 'w') as f:
            f.write(body_html)
        ...
        # Write URL as a csv
        url_list = '\n'.join(url_list)
        with open(f"Odds-Scraping/LPL/Bet365/urls.csv", 'w') as f:
           f.write(url_list)
