...
# Get element of competitions that equals "LPL"
lpl_index <- which(tab_competitions == "LPL")

# Map functions to data
all_tab_markets <-
  map(tab_response$competitions[[lpl_index]]$matches, get_match_info) |> bind_rows()
...
# Write to csv
h2h_new |> 
write_csv("Data/T20s/LPL/scraped_odds/tab_h2h.csv")
...
player_runs |>
  write_csv("Data/T20s/LPL/scraped_odds/tab_player_runs.csv")
...
player_wickets_alt |> 
  write_csv("Data/T20s/LPL/scraped_odds/tab_player_wickets.csv")
...
player_boundaries_alt |> 
  write_csv("Data/T20s/LPL/scraped_odds/tab_player_boundaries.csv")
...
match_boundaries_overs |>
  ...
  write_csv("Data/T20s/LPL/scraped_odds/tab_match_total_fours.csv")
...
match_boundaries_overs |>
  ...
  write_csv("Data/T20s/LPL/scraped_odds/tab_match_total_sixes.csv")
