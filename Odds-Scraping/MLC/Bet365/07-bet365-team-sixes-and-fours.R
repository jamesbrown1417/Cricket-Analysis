...
scraped_files_team_boundaries <- list.files("Odds-Scraping/MLC/Bet365/HTML", full.names = TRUE, pattern = "body_html_team")
...
# Output as a csv
write_csv(total_team_fours, "Data/T20s/Major League Cricket/scraped_odds/bet365_team_fours.csv")
write_csv(total_team_sixes, "Data/T20s/Major League Cricket/scraped_odds/bet365_team_sixes.csv")