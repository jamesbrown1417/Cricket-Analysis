...
scraped_files_fofw <- list.files("Odds-Scraping/MLC/Bet365/HTML", full.names = TRUE, pattern = "body_html_team")
...
# Output as a csv
write_csv(fofw_runs_all, "Data/T20s/Major League Cricket/scraped_odds/bet365_runs_at_first_wicket.csv")
