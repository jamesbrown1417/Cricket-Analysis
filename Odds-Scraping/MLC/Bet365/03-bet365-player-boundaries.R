...
scraped_files_player <- list.files("Odds-Scraping/MLC/Bet365/HTML", full.names = TRUE, pattern = "player")
...
# Output as a csv
write_csv(player_boundaries, "Data/T20s/Major League Cricket/scraped_odds/bet365_player_boundaries.csv")