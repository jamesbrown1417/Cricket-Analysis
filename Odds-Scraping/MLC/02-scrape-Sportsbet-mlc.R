...
player_props_function <- function() {
  ...
  highest_opening_partnership <-
    ...
    transmute(
      ...
      home_team,
      away_team,
      team = fix_team_names_mlc(selection_name_prop),
      price = prop_market_price,
      agency = "Sportsbet"
    )
  ...
  total_match_run_outs <-
    total_match_run_outs_overs |>
    left_join(total_match_run_outs_unders, by = c("match", "home_team", "away_team", "line", "market")) |>
    mutate(agency = "Sportsbet")
  ...
  write_csv(team_totals,
            "Data/T20s/Major League Cricket/scraped_odds/sportsbet_team_totals.csv")
  
  write_csv(highest_opening_partnership,
            "Data/T20s/Major League Cricket/scraped_odds/sportsbet_highest_opening_partnership.csv")
  
  write_csv(team_to_score_most_fours,
            "Data/T20s/Major League Cricket/scraped_odds/sportsbet_team_to_score_most_fours.csv")
  
  write_csv(team_to_score_most_sixes,
            "Data/T20s/Major League Cricket/scraped_odds/sportsbet_team_to_score_most_sixes.csv")
  
  write_csv(team_of_top_batter,
            "Data/T20s/Major League Cricket/scraped_odds/sportsbet_team_of_top_batter.csv")
  
  write_csv(total_match_run_outs,
            "Data/T20s/Major League Cricket/scraped_odds/sportsbet_total_match_run_outs.csv")
