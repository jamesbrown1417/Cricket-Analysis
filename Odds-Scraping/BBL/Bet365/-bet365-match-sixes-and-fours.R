...
scraped_files_boundaries <- list.files("Odds-Scraping/BBL/Bet365/HTML", full.names = TRUE, pattern = "body_html_match")
...
# Output as a csv
write_csv(total_match_fours, "Data/T20s/Big Bash/scraped_odds/bet365_total_match_fours.csv")
write_csv(total_match_sixes, "Data/T20s/Big Bash/scraped_odds/bet365_total_match_sixes.csv")
write_csv(total_match_boundaries, "Data/T20s/Big Bash/scraped_odds/bet365_total_match_boundaries.csv")