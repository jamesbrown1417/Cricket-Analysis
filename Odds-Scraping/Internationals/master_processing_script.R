...
# run_scraping("Odds-Scraping/Internationals/scrape_betr.R")
# run_scraping("Odds-Scraping/Internationals/scrape_BetRight.R")
# run_scraping("Odds-Scraping/Internationals/scrape_pointsbet.R")
run_scraping("Odds-Scraping/Internationals/02-scrape-Sportsbet-internationals.R")
run_scraping("Odds-Scraping/Internationals/TAB/01-scrape-TAB-internationals.R")
# run_scraping("Odds-Scraping/Internationals/04-scrape-topsport-internationals.R")
# run_scraping("Odds-Scraping/Internationals/Neds/scrape_neds.R")
# run_scraping("Odds-Scraping/Internationals/scrape_dabble.R")
...
# Write out 
write_rds(h2h_data, "Data/T20s/Internationals/processed_odds/h2h.rds")
...
# Write out 
write_rds(fofw_data, "Data/T20s/Internationals/processed_odds/runs_at_first_wicket.rds")
...
# Write out 
write_rds(for_data, "Data/T20s/Internationals/processed_odds/first_over_runs.rds")
...
# Write out 
write_rds(ms_data, "Data/T20s/Internationals/processed_odds/match_sixes.rds")
...
# Write out 
write_rds(mf_data, "Data/T20s/Internationals/processed_odds/match_fours.rds")
...
# Write out
write_rds(ts_data, "Data/T20s/Internationals/processed_odds/team_sixes.rds")
...
# Write out
write_rds(tf_data, "Data/T20s/Internationals/processed_odds/team_fours.rds")
...
# Write out
write_rds(br_data, "Data/T20s/Internationals/processed_odds/player_runs.rds")
...
list_of_bw_files <- list.files("Data/T20s/Internationals/scraped_odds/", full.names = TRUE, pattern = "player_wickets")
...
# Write out
write_rds(bw_data, "Data/T20s/Internationals/processed_odds/player_wickets.rds")
...
list_of_ttwt_files <- list.files("Data/T20s/Internationals/scraped_odds/", full.names = TRUE, pattern = "top_team_wicket_taker")
