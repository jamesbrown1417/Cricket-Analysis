...
OUTPUT_PATH = "/Users/jamesbrown/Projects/Cricket-Analysis/Odds-Scraping/CPL/TAB/tab_response.json"
...
async def main():
    ...
    async with webdriver.Chrome(options=options) as driver:
        ...
        api_url = "https://api.beta.tab.com.au/v1/tab-info-service/sports/Cricket/competitions/Caribbean%20Premier%20League?jurisdiction=SA"
