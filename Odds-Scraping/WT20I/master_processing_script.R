...
list_of_h2h_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "h2h")
...
# Write out 
write_rds(h2h_data, "Data/T20s/WT20I/processed_odds/h2h.rds")
...
list_of_fofw_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "runs_at_first_wicket.csv")
...
# Write out 
write_rds(fofw_data, "Data/T20s/WT20I/processed_odds/runs_at_first_wicket.rds")
...
list_of_for_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "first_over_runs.csv")
...
# Write out 
write_rds(for_data, "Data/T20s/WT20I/processed_odds/first_over_runs.rds")
...
list_of_ms_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "match_sixes")
...
# Write out 
write_rds(ms_data, "Data/T20s/WT20I/processed_odds/match_sixes.rds")
...
list_of_mf_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "match_fours")
...
# Write out 
write_rds(mf_data, "Data/T20s/WT20I/processed_odds/match_fours.rds")
...
list_of_ts_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "team_sixes")
...
# Write out
write_rds(ts_data, "Data/T20s/WT20I/processed_odds/team_sixes.rds")
...
list_of_tf_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "team_fours")
...
# Write out
write_rds(tf_data, "Data/T20s/WT20I/processed_odds/team_fours.rds")
...
list_of_br_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "player_runs")
...
# Write out
write_rds(br_data, "Data/T20s/WT20I/processed_odds/player_runs.rds")
...
list_of_bw_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "player_wickets")
...
# Write out
write_rds(bw_data, "Data/T20s/WT20I/processed_odds/player_wickets.rds")
...
list_of_ttwt_files <- list.files("Data/T20s/WT20I/scraped_odds/", full.names = TRUE, pattern = "top_team_wicket_taker")
