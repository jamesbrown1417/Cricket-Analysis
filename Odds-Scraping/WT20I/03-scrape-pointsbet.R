...
pointsbet_h2h_main <- function() {
  ...
  # URL of website
  pointsbet_url = "https://api.au.pointsbet.com/api/v2/competitions/20704/events/featured?includeLive=false"
  ...
  # Write to csv
  write_csv(pointsbet_h2h, "Data/T20s/WT20I/scraped_odds/pointsbet_h2h.csv")
  ...
  pointsbet_player_runs_lines |> 
    ...
    write_csv("Data/T20s/WT20I/scraped_odds/pointsbet_player_runs.csv")
  ...
  # Write to csv----------------------------------------------------------------
  pointsbet_player_wickets_lines |> 
    write_csv("Data/T20s/WT20I/scraped_odds/pointsbet_player_wickets.csv")
  ...
  pointsbet_player_sixes_lines |> 
    ...
    write_csv("Data/T20s/WT20I/scraped_odds/pointsbet_player_boundaries.csv")
