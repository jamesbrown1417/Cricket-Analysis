...
# URL of website
topsport_url = "https://www.topsport.com.au/Sport/Cricket/Womens_T20_CWC_Matches/Matches"
...
# Function to fix team names for TopSport WT20I
...
head_to_head_main <- function() {
  ...
  # Write to csv
  write_csv(topsport_h2h, "Data/T20s/WT20I/scraped_odds/topsport_h2h.csv")
}
...
player_runs_all |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_player_runs.csv")
...
player_wickets |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_player_wickets.csv")
...
player_boundaries |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_player_boundaries.csv")
...
first_over_runs |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_first_over_runs.csv")
...
# Write out
runs_at_first_wicket_team_runs_all |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_runs_at_first_wicket.csv")
...
# Write out
most_team_wickets |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_top_team_wicket_taker.csv")
...
# Write out
highest_opening_partnership |> 
  write_csv("Data/T20s/WT20I/scraped_odds/topsport_highest_opening_partnership.csv")
