...
scraped_files_player <- list.files("Odds-Scraping/WT20I/Bet365/HTML", full.names = TRUE, pattern = "player")
...
# Output as a csv
write_csv(player_wickets, "Data/T20s/WT20I/scraped_odds/bet365_player_wickets.csv")