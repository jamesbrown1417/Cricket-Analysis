...
scraped_files_first_over <- list.files("Odds-Scraping/WT20I/Bet365/HTML", full.names = TRUE, pattern = "first_over")
...
# Output as a csv
write_csv(first_over_runs_all, "Data/T20s/WT20I/scraped_odds/bet365_first_over_runs.csv")
