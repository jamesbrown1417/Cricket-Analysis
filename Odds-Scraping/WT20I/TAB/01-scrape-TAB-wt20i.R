...
# Get response body
tab_response <- fromJSON("Odds-Scraping/WT20I/TAB/tab_response.json")
...
# Function to fix team names for TAB International
fix_team_names <- function(team_name_vector) {
  team_name_vector <- case_when(
    str_detect(team_name_vector, "Bangladesh|Bangldsh") ~ "Bangladesh",
    str_detect(team_name_vector, "England") ~ "England",
    str_detect(team_name_vector, "India") ~ "India",
    str_detect(team_name_vector, "New Zealand|NZ") ~ "New Zealand",
    str_detect(team_name_vector, "Pakistan|Pak") ~ "Pakistan",
    str_detect(team_name_vector, "South Africa|SAfrica") ~ "South Africa",
    str_detect(team_name_vector, "Sri Lanka|SriLanka") ~ "Sri Lanka",
    str_detect(team_name_vector, "West Indies|WIndies") ~ "West Indies",
    str_detect(team_name_vector, "Australia|Aus") ~ "Australia",
...
# Write to csv
h2h_new |> 
write_csv("Data/T20s/WT20I/scraped_odds/tab_h2h.csv")
...
player_runs |>
  write_csv("Data/T20s/WT20I/scraped_odds/tab_player_runs.csv")
...
player_wickets_alt |> 
  write_csv("Data/T20s/WT20I/scraped_odds/tab_player_wickets.csv")
...
player_boundaries_alt |> 
  write_csv("Data/T20s/WT20I/scraped_odds/tab_player_boundaries.csv")
...
fall_of_first_wicket_overs |>
  ...
  mutate(team = fix_team_names(team)) |> 
  write_csv("Data/T20s/WT20I/scraped_odds/tab_runs_at_first_wicket.csv")
...
first_over_runs_overs |>
  ...
  mutate(team = case_when(team == "Aus" ~ "Australia",
                          team == "Sct" ~ "Scotland",
                          TRUE ~ team)) |>
  write_csv("Data/T20s/WT20I/scraped_odds/tab_first_over_runs.csv")
...
team_boundaries_overs |>
  ...
  mutate(team = case_when(team == "Aus" ~ "Australia",
                          team == "Sct" ~ "Scotland",
                          TRUE ~ team)) |>
  write_csv("Data/T20s/WT20I/scraped_odds/tab_team_total_4s.csv")
...
team_boundaries_overs |>
  ...
  mutate(team = case_when(team == "Aus" ~ "Australia",
                          team == "Sct" ~ "Scotland",
                          TRUE ~ team)) |>
  write_csv("Data/T20s/WT20I/scraped_odds/tab_team_total_6s.csv")
...
match_boundaries_overs |>
  ...
  mutate(match = paste(home_team, "v", away_team)) |>
  select(-home_team, -away_team) |>
  write_csv("Data/T20s/WT20I/scraped_odds/tab_match_total_fours.csv")
...
match_boundaries_overs |>
  ...
  mutate(match = paste(home_team, "v", away_team)) |>
  select(-home_team, -away_team) |>
  write_csv("Data/T20s/WT20I/scraped_odds/tab_match_total_sixes.csv")
...
# Write out
most_team_wickets |> 
  write_csv("Data/T20s/WT20I/scraped_odds/tab_top_team_wicket_taker.csv")
...
# Write out
highest_opening_partnership |> 
  write_csv("Data/T20s/WT20I/scraped_odds/tab_highest_opening_partnership.csv")
