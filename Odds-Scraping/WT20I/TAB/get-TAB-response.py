...
tab_url = "https://api.beta.tab.com.au/v1/tab-info-service/sports/Cricket/competitions/ICC%20Womens%20T20%20World%20Cup?jurisdiction=SA"
...
if tab_response is not None:
    ...
    with open("Odds-Scraping/WT20I/TAB/tab_response.json", "w") as json_file:
