...
betright_url = "https://next-api.betright.com.au/Sports/Category?categoryId=42581"

# Function to fix team names for BetRight WT20I
...
# Write to csv
write_csv(betright_head_to_head_markets, "Data/T20s/WT20I/scraped_odds/betright_h2h.csv")
...
highest_opening_partnership |> write_csv("Data/T20s/WT20I/scraped_odds/betright_highest_opening_partnership.csv")
first_over_runs |> write_csv("Data/T20s/WT20I/scraped_odds/betright_first_over_runs.csv")
total_match_sixes |> write_csv("Data/T20s/WT20I/scraped_odds/betright_total_match_sixes.csv")
total_match_fours |> write_csv("Data/T20s/WT20I/scraped_odds/betright_total_match_fours.csv")
batsman_runs |> write_csv("Data/T20s/WT20I/scraped_odds/betright_player_runs.csv")
