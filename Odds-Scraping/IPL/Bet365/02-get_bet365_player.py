...
url_df = pd.read_csv('Odds-Scraping/BBL/Bet365/player_urls.csv', header=None)
    ...
    async with webdriver.Chrome(options=options) as driver:
        for index, url in enumerate(url_df, start=1): # Start counting from 1 for match_n
            try:
                ...
                with open(f"Odds-Scraping/BBL/Bet365/HTML/body_html_players_match_{index}.txt", 'w') as f:
