...
betright_url = "https://next-api.betright.com.au/Sports/Category?categoryId=2386"
...
# Write to csv
write_csv(betright_head_to_head_markets, "Data/T20s/IPL/scraped_odds/betright_h2h.csv")
...
batsman_runs_overs <-
  ...
  filter(str_detect(outcome_name, "\\+")) |>
  mutate(line = as.numeric(str_extract(outcome_name, "[0-9\\.]{1,4}")) - 0.5) |>
  mutate(group_by_header = str_remove_all(group_by_header, "Player Runs \\- ")) |>
  mutate(market = "Batsman Runs", agency = "BetRight") |>
  mutate(group_by_header = str_remove_all(group_by_header, " \\(.*$")) |>
...
highest_opening_partnership |> write_csv("Data/T20s/IPL/scraped_odds/betright_highest_opening_partnership.csv")
first_over_runs |> write_csv("Data/T20s/IPL/scraped_odds/betright_first_over_runs.csv")
total_match_sixes |> write_csv("Data/T20s/IPL/scraped_odds/betright_total_match_sixes.csv")
most_sixes |> write_csv("Data/T20s/IPL/scraped_odds/betright_most_sixes.csv")
most_fours |> write_csv("Data/T20s/IPL/scraped_odds/betright_most_fours.csv")
total_match_fours |> write_csv("Data/T20s/IPL/scraped_odds/betright_total_match_fours.csv")
batsman_runs |> write_csv("Data/T20s/IPL/scraped_odds/betright_player_runs.csv")
