...
# Get response body
tab_response <- fromJSON("Odds-Scraping/IPL/TAB/tab_response.json")
...
# Function to fix team names for TAB IPL
...
# Write to csv
h2h_new |> 
write_csv("Data/T20s/IPL/scraped_odds/tab_h2h.csv")
...
player_runs |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_player_runs.csv")
...
player_wickets_alt |> 
  write_csv("Data/T20s/IPL/scraped_odds/tab_player_wickets.csv")
...
player_boundaries_alt |> 
  write_csv("Data/T20s/IPL/scraped_odds/tab_player_boundaries.csv")
...
fall_of_first_wicket_overs |>
  ...
  mutate(home_team = fix_team_names(home_team),
         away_team = fix_team_names(away_team)) |>
  mutate(match = paste(home_team, "v", away_team)) |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_runs_at_first_wicket.csv")
...
first_over_runs_overs |>
  ...
  mutate(team = case_when(team == "MStr" ~ "Melbourne Stars",
                          ...
                          team == "Ade" ~ "Adelaide Strikers",
                          TRUE ~ team))  |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_first_over_runs.csv")
...
team_boundaries_overs |>
  ...
  mutate(team = case_when(team == "MStr" ~ "Melbourne Stars",
                          ...
                          team == "Ade" ~ "Adelaide Strikers",
                          TRUE ~ team))  |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_team_total_4s.csv")
...
team_boundaries_overs |>
  ...
  mutate(team = case_when(team == "MStr" ~ "Melbourne Stars",
                          ...
                          team == "Ade" ~ "Adelaide Strikers",
                          TRUE ~ team))  |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_team_total_6s.csv")
...
match_boundaries_overs |>
  ...
  mutate(match = paste(home_team, "v", away_team)) |>
  select(-home_team, -away_team) |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_match_total_fours.csv")
...
match_boundaries_overs |>
  ...
  mutate(match = paste(home_team, "v", away_team)) |>
  select(-home_team, -away_team) |>
  write_csv("Data/T20s/IPL/scraped_odds/tab_match_total_sixes.csv")
...
# Write out
most_team_wickets |> 
  write_csv("Data/T20s/IPL/scraped_odds/tab_top_team_wicket_taker.csv")
...
# Write out
highest_opening_partnership |> 
  write_csv("Data/T20s/IPL/scraped_odds/tab_highest_opening_partnership.csv")
