...
tab_url = "https://api.beta.tab.com.au/v1/tab-info-service/sports/Cricket/competitions/IPL%20Matches?jurisdiction=SA"
...
if tab_response is not None:
    ...
    with open("Odds-Scraping/IPL/TAB/tab_response.json", "w") as json_file:
