# The Hundred Sportsbet Scraper
# ==============================
# Uses the centralized scrape_sportsbet function from Functions/

source("Functions/scrape_sportsbet.R")

# The Hundred-specific player name fixes
fix_player_names_hundred <- function(player_name_vector) {
  case_when(
...
scrape_sportsbet(
  ...
  output_dir = "Data/T20s/The Hundred/scraped_odds",
  competition_name = "The Hundred",
  fix_player_names = fix_player_names_hundred,
  use_live_html = FALSE
)
